        ...
        <Col lg={6} className="Exp_Col">
          ...
          <div className="Exp_Content">
            ...
            <p className="exp_p">
              ...
              My best experience is to create React projects and deploy them to
              web applications.
            </p>
          </div>
          </Bounce>
        ...
        <Col className="Second_Row">
          ...
          <Card style={{ width: "18rem" }} className="Sec_Card">
            <Card.Body>
              ...
              <Card.Text>
                ...
                <p>
                  Through Stronger application’s admin portal, Trainers, Plans,
                  and Reward Coin can be added and managed by the admin.
                </p>
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card style={{ width: "18rem" }} className="Sec_Card">
            <Card.Body>
              ...
              <Card.Text>
                <p>This application provides information about my portfolio.</p>
                <p>
          ...
          <Card style={{ width: "18rem" }} className="Sec_Card">
            <Card.Body>
              ...
              <Card.Text>
                ...
                <p>
                  Through this application’s we can come across CRUD operations,
                  HTTP integration and form Validations etc.
                </p>
              </Card.Text>
            </Card.Body>
          </Card>
